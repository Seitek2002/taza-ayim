              ...
              {plans.map((plan, idx) => (
                ...
                >
                  ...
                  <div className='text-center'>
                    ...
                    <a
                      href={`https://wa.me/996709058182?text=Здравствуйте, интересует абонемент на ${plan.time}`}
                      target='_blank'
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto'>
              {rooms.map((item, idx) => (
                ...
                >
                  ...
                  <a
                    href={`https://wa.me/996709058182?text=Здравствуйте, интересует организация пространства: ${item.room}`}
                    target='_blank'
